...
Function_name='F13'; % Name of the test function that can be from F1 to F23 (Table 1,2,3 in the paper)

Max_iter=100; % Maximum numbef of iterations

% Load details of the selected benchmark function
[lb,ub,dimension,Func]=Get_Functions_details(Function_name);

[Best_score,Best_pos,cg_curve]=ALO(SearchAgents_no,Max_iter,lb,ub,dimension,Func);
